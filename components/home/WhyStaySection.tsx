...
export default function WhyStaySection() {
  return (
    <div className="flex flex-col w-full">
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-9">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-8 text-[13px] text-charcoal/70 font-sans font-semibold">
                <span className="flex items-center gap-2 border border-[#DDDDDD] p-3 bg-white rounded-md shadow-sm">Massage Therapy</span>
                <span className="flex items-center gap-2 border border-[#DDDDDD] p-3 bg-white rounded-md shadow-sm">Aromatherapy</span>
                <span className="flex items-center gap-2 border border-[#DDDDDD] p-3 bg-white rounded-md shadow-sm">Facial Treatments</span>
                <span className="flex items-center gap-2 border border-[#DDDDDD] p-3 bg-white rounded-md shadow-sm">Relaxation Lounge</span>
              </div>
            ...
            <motion.div
              ...
              className="lg:col-span-7 relative h-[350px] sm:h-[450px] lg:h-[500px] border border-[#DDDDDD] overflow-hidden group rounded-md shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            >
              <Image
                src="/assets/spa2.jpg"
      ...
      <section id="weddings" className="py-28 bg-muted" aria-label="Weddings and celebrations">
        <div className="max-w-[1440px] mx-auto px-4 md:px-9">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            {/* Left side: Image */}
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 0.6 }}
              className="lg:col-span-7 order-2 lg:order-1 relative h-[350px] sm:h-[450px] lg:h-[500px] border border-[#DDDDDD] overflow-hidden group rounded-md shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            >
              <Image
            ...
            >
              <span className="text-ocean-teal text-[11px] uppercase tracking-[0.3em] font-sans font-semibold mb-2 block">
                Social Moments
              </span>
              <h2 className="font-serif text-[38px] font-normal text-deep-navy leading-tight mb-6">
